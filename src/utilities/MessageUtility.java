...
public class MessageUtility {
	 ...
	 * @param isSuccess - Result of boolean function
	 */
	 ...
	 * @param className - use Implicit name or            <code>this.getClass().getSimpleName()</code>
	 * @param name      - Name of the Animal
	 */
	 ...
	 *
	 * @param name     - Name of the Animal
	 * @param funcName - Calling Getter Name
	 ...
	 *
	 * @param name      - Name of the Animal
	 * @param funcName  - Calling Setter Name
	 * @param value     - Returned value
	 * @param isSuccess - Did the assignment take place
	 */
